...
class VisualCanvas():
    ...
    def __init__(self,nr,deposito,deposito2):
        ...
        self._buttonIniciaProcesso2_ = Button(master=self._janela_, text="Inicia Processo - Deposito Local", command=self.iniciaProcesso2)
        self._buttonIniciaProcesso3_ = Button(master=self._janela_, text="Inicia Processo - Sem Controle de Semaforo", command=self.iniciaProcesso3)
        self._buttonIniciaProcesso4_ = Button(master=self._janela_, text="Inicia Processo - Deposito Local Sem Semaforo", command=self.iniciaProcesso4)
    ...
    def executarProcesso(self,disparado):
        ...
        for i in range(10):
            ...
            self.processo()
            fim = time.perf_counter()
            self.escreveLinha("Rodando "+str(i)+ " Tempo: " + str(round(fim - inicio, 1)))
